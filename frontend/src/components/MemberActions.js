    ...
    <div className="max-w-lg mx-auto p-4 bg-white shadow-md rounded-md">
      ...
      <form onSubmit={handleFetchMember} className="mb-4">
        ...
        <div className="form-group">
          <input
            className="btn btn-primary w-full bg-blue-500 text-white py-2 px-4 rounded-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
            type="submit"
      ...
      {memberData && (
        <div className="mb-4">
          ...
          <form onSubmit={handleMakeContribution}>
            ...
            <div className="form-group">
              <input
                className="btn btn-primary w-full bg-green-500 text-white py-2 px-4 rounded-md hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2"
                type="submit"
