  ...
  const fetchProviderData = async (address) => {
    try {
      ...
      const response = await axios.get(
        `https://nhifdevbackend.onrender.com/api/providers?address=${address}`,
      );
  ...
  return (
    <Slide direction="up">
      <div className="mx-auto p-6 bg-white shadow-md rounded-md">
        <h4 className="text-2xl font-bold mb-6 text-customBlue">
          Check Provider
        </h4>
        ...
        {providerData && (
          <div className="mt-6 bg-gray-50 p-6 rounded-md shadow-sm">
            <h5 className="text-xl font-semibold mb-4 text-customBlue">
              Provider Data
            </h5>
